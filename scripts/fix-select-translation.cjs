...
const jsFile = '/Users/mc/.openclaw/workspace/torchlight-of-building/src/locales/zh/common.js';
...
if (content.includes(target)) {
  ...
  if (content.includes(target2)) {
    ...
    fs.writeFileSync(jsFile, content, 'utf8');
    console.log('✓ Successfully added <Select {affixType}> translation (method 2)');
  } else {
