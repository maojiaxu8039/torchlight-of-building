...
// 从网站抓取 Craft 页面提取所有词条
async function scrapeFromWebsite() {
  const translations = {};

  console.log('📄 Scraping from tlidb.com...\n');
...
async function main() {
  console.log('🚀 Starting complete affix matching...\n');
  ...
  console.log(`  ✅ Total website translations: ${Object.keys(websiteTranslations).length}\n`);
  ...
  // 4. 更新 complete-affix-translations.ts
