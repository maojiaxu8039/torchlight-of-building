...
async function main() {
  ...
  const equipmentTypes = [
    ...
    'One_Handed_Weapon', 'Two_Handed_Weapon',
    'Claw', 'Sword', 'Axe', 'Hammer', 'Staff', 'Rod', 'Wand',
    'Bow', 'Crossbow', 'Gun', 'Pistol', 'Musket', 'Cannon', 'Dagger',
    'Scythe', 'Maul', 'Spear',
    'Shield', 'Necklace', 'Ring',
    'Waistguard', 'Breastpin', 'Plume', 'Reversal',
    'STR_Waistguard', 'DEX_Waistguard', 'INT_Waistguard',
    'STR_Breastpin', 'DEX_Breastpin', 'INT_Breastpin',
  ];
