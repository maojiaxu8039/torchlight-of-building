...
const matches = content.match(/export const AFFIX_NAME_TRANSLATIONS: Record<string, string> = \{[\s\S]*?\};/);
...
console.log(`Original translations: ${Object.keys(existingTranslations).length}`);
