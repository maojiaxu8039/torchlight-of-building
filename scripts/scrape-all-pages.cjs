...
async function scrapePage(enUrl, cnUrl, pageName) {
  ...
  try {
    ...
    console.log(`EN modifiers: ${Object.keys(enById).length}, CN modifiers: ${Object.keys(cnById).length}`);
...
async function main() {
  ...
  const pages = [
    // Belt - Base Affixes
    { en: 'https://tlidb.com/en/Belt', cn: 'https://tlidb.com/cn/Belt', type: 'Base Affix' },
    { en: 'https://tlidb.com/en/STR_Helmet', cn: 'https://tlidb.com/cn/STR_Helmet', type: 'Base Affix' },
    { en: 'https://tlidb.com/en/DEX_Helmet', cn: 'https://tlidb.com/cn/DEX_Helmet', type: 'Base Affix' },
    { en: 'https://tlidb.com/en/INT_Helmet', cn: 'https://tlidb.com/cn/INT_Helmet', type: 'Base Affix' },
    { en: 'https://tlidb.com/en/STR_Gloves', cn: 'https://tlidb.com/cn/STR_Gloves', type: 'Base Affix' },
    { en: 'https://tlidb.com/en/DEX_Gloves', cn: 'https://tlidb.com/cn/DEX_Gloves', type: 'Base Affix' },
    { en: 'https://tlidb.com/en/INT_Gloves', cn: 'https://tlidb.com/cn/INT_Gloves', type: 'Base Affix' },
    { en: 'https://tlidb.com/en/STR_Boots', cn: 'https://tlidb.com/cn/STR_Boots', type: 'Base Affix' },
    { en: 'https://tlidb.com/en/DEX_Boots', cn: 'https://tlidb.com/cn/DEX_Boots', type: 'Base Affix' },
    { en: 'https://tlidb.com/en/INT_Boots', cn: 'https://tlidb.com/cn/INT_Boots', type: 'Base Affix' },
  ];
  ...
  for (const page of pages) {
    const translations = await scrapePage(page.en, page.cn, `${page.type} - ${page.en.split('/').pop()}`);
  ...
  console.log('\n=== Sample translations ===\n');
  let count = 0;
  Object.entries(allTranslations).slice(0, 10).forEach(([en, cn]) => {
