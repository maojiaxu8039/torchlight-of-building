...
const weaponTranslations = {
  "+(111-145)% Gear Physical Damage Adds (69-71) - (85-87) Physical Damage to the gear":
    "+(111-145)% 该装备物理伤害在该装备上附加 (69-71) - (85-87) 点物理伤害",
  "+(77-110)% Gear Physical Damage Adds (53-55) - (65-67) Physical Damage to the gear":
    "+(77-110)% 该装备物理伤害在该装备上附加 (53-55) - (65-67) 点物理伤害",
...
let added = 0;
Object.entries(weaponTranslations).forEach((entry) => {
  const en = entry[0];
  const cn = entry[1];
