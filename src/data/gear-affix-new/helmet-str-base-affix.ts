...
export const HELMET_STR_BASE_AFFIX_AFFIXES: readonly BaseGearAffix[] = [
  ...
  },
  {
    ...
    craftingPool: "Basic",
    tier: "1",
    craftableAffix: "When dealing damage, inflicts Fire Infiltration. Interval for each enemy: 1 sWhen Minions deal damage, inflicts Fire Infiltration. Interval for each enemy: 1 s",
  },
  {
    equipmentSlot: "Trinket",
    equipmentType: "Helmet-Str",
