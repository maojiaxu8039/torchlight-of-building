...
export const TWO_HANDED_HAMMER_BASE_AFFIX_AFFIXES: readonly BaseGearAffix[] = [
  ...
  },
  {
    ...
    craftingPool: "Basic",
    tier: "1",
    craftableAffix: "+(28-32)% additional damage when a Skill consumes Demolisher Charge",
  },
  {
    equipmentSlot: "Weapon",
    equipmentType: "Two-Handed-Hammer",
    ...
    craftingPool: "Basic",
    tier: "1",
    craftableAffix: "Eliminates enemies under (10-14)% Life upon inflicting damage",
  },
  {
    equipmentSlot: "Weapon",
    equipmentType: "Two-Handed-Hammer",
