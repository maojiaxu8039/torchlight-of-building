...
export const CHEST_STR_SUFFIX_AFFIXES: readonly BaseGearAffix[] = [
  ...
  },
  {
    ...
    craftingPool: "Advanced",
    tier: "1",
    craftableAffix: "When dealing damage, inflicts Fire Infiltration. Interval for each enemy: 1 sWhen Minions deal damage, inflicts Fire Infiltration. Interval for each enemy: 1 s+(10-30)% Fire Infiltration Effect",
  },
] as const;
